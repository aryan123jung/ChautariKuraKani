import 'package:chautari_kurakani/screens/signup/signup_bio_screen.dart';
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>SignupProfilepictureScreen()));},
              
              child: Icon(
                Icons.arrow_back,
                color: Colors.black, // Optional: set the color of the icon
                size: 30.0, // Optional: set the size of the icon
                semanticLabel: 'Back button', // Optional: for accessibility
